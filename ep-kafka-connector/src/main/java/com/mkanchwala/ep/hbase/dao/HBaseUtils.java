...
public class HBaseUtils {
	private final static String tableName = "WordCount";
	private final static String columnFamily = "w1";

	public static void main(String[] args) throws Exception {
		Configuration conf = HBaseConfiguration.create();
		conf.addResource(new Path("file:///ep-kafka-connector/src/main/resources/hbase-site.xml"));
